...
@section('content')
	<form action="/admin/documenttype/create" method="POST" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-2">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Tên loại tài liệu" name="name">
									</div>
								</div>
							</div>
							<div class="row">
