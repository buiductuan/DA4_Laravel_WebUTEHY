...
@section('content')
	<form action="/admin/faculty/create" method="POST">
		<div class="row">
			<div class="col-md-2">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" placeholder="Mã khoa" name="facultyID" class="form-control">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="">Tên khoa <small class="text-danger">(*)</small></label>
										<input type="text" placeholder="Tên khoa" name="facultyName" class="form-control">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="form-group">
									...
									<textarea name="facultyDesc" class="form-control" rows="4"></textarea>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" placeholder="Tên khoa" name="link" class="form-control">
									</div>
								</div>
							</div>
						</div>
