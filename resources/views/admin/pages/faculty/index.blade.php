		...
		<div class="col-md-10">
			<div class="panel panel-default">
				...
				<div class="panel-body">
							...
							<tbody>
								...
								@foreach($faculties as $item)
									<tr>
										...
										<td>
											<a href="/admin/faculty/delete/{{$item->id}}">
					...
					@else
						<h3 class="text-center">Không có Khoa nào trong hệ thống.</h3>
						<h4 class="text-center">Vui lòng thêm Khoa mới <a href="{{ route('faculty_create') }}"> tại đây.</a></h4>
					@endif
				</div>
			</div>
		</div>
				...
				bootbox.confirm({
					...
					callback:function(result){
						if(result){
						    ...
						    $.get("/admin/faculty/delete/multi/"+vals);
						    location.reload();
						}
					}
				});
