...
@section('content')
	<form action="/admin/albumfile/create" id="frm_album" method="POST" enctype="multipart/form-data">
		<div class="row">
			<div class="col-md-2">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" placeholder="Tên Album" name="name" class="form-control">
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">
									<label for="">Sắp xếp</label>
									<input type="number" value="0" name="orderBy" class="form-control" placeholder="Sắp xếp">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="radio" value="1" checked="" name="rdStatus"> Có
									<input type="radio" value="0" name="rdStatus"> Không
								</div>
							</div>
						</div>
						<div class="row">
